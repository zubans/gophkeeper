...
func testCompleteWorkflow(t *testing.T, cli *client.Client) {
	...
	// 7. Clean up test data - delete all added data
...
func TestClientCLI(t *testing.T) {
	...
	// Test CLI commands - all in one test to share user
...
func TestDataPersistence(t *testing.T) {
	...
	// List data to verify persistence
	err = cli2.ListData()
	if err != nil {
