...
// Server represents the GophKeeper HTTP server.
type Server struct {
	db          *database.DB
...
// handleGetData handles getting user data.
...
// handleCreateData handles creating new data.
...
// handleUpdateData handles updating existing data.
...
// handleDeleteData handles deleting data.
...
// handleSyncData handles data synchronization.
